...
# Form implementation generated from reading ui file 'c:\Users\morzb\OneDrive\Рабочий стол\test_app\test_app\testing_gui.ui'
#
...
"    }")
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(330, 150, 511, 440))
...
"    }")
        ...
        self.dezh_po_parku = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.dezh_po_parku.setMinimumSize(QtCore.QSize(0, 68))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.dezh_po_parku.setFont(font)
        self.dezh_po_parku.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.dezh_po_parku.setStyleSheet("    QPushButton {\n"
"        background-color: #0171CA;\n"
"        color: rgb(255, 255, 255);\n"
"        border-radius: 10px;\n"
"    }\n"
...
"        border-color: #0171CA;\n"
"    }")
        self.dezh_po_parku.setObjectName("dezh_po_parku")
        self.verticalLayout.addWidget(self.dezh_po_parku)
        self.dezh_po_UBM = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.dezh_po_UBM.setMinimumSize(QtCore.QSize(0, 68))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.dezh_po_UBM.setFont(font)
        self.dezh_po_UBM.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.dezh_po_UBM.setStyleSheet("    QPushButton {\n"
"        background-color: #0171CA;\n"
"        color: rgb(255, 255, 255);\n"
"        border-radius: 10px;\n"
"    }\n"
...
"        border-color: #0171CA;\n"
"    }")
        self.dezh_po_UBM.setObjectName("dezh_po_UBM")
        self.verticalLayout.addWidget(self.dezh_po_UBM)
...
"    }")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.dezh_po_parku.setText(_translate("MainWindow", "Дежурный по парку"))
        self.dezh_po_UBM.setText(_translate("MainWindow", "Дежурный по УБМ"))
